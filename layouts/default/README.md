...
These JSON files are mirrored in the Python sources under `src/glove80/default`, where each layout is described as declarative layer specs similar to TailorKey and QuantumTouch.
